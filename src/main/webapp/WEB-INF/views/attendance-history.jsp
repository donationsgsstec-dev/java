...
<body>
    <div class="container">
        ...
        <div class="header-card">
            ...
            <form action="${pageContext.request.contextPath}/attendance/history" method="get" class="filter-form">
                ...
                <a href="${pageContext.request.contextPath}/attendance/history" class="btn" style="background-color: #6c757d; color: white;">Clear Filter</a>
            </form>
        </div>
